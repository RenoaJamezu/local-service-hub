...
export default function BookingCard({
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-lg p-4 sm:p-5 flex flex-col min-h-72 sm:min-h-80 animate-pulse fade-slide-in">
        <div className="flex gap-2 mb-3">
          <div className="bg-primary/25 rounded-lg p-2">
            <HiOutlineWrench className="text-2xl sm:text-3xl text-primary" />
          </div>
          <div className="flex flex-col w-full gap-1">
            <div className="w-3/5 h-5 sm:h-6 bg-gray-300"></div>
            <div className="w-1/4 h-4 sm:h-5 bg-gray-300"></div>
          </div>
        </div>
        <div className="w-3/5 h-3.5 sm:h-4 bg-gray-300 mb-1"></div>
        <div className="w-3/5 h-3.5 sm:h-4 bg-gray-300 mb-3"></div>
        <div className="bg-muted h-14 sm:h-16"></div>
      </div>
    );
  }

  return (
    <div className="bg-white rounded-lg p-4 sm:p-5 flex flex-col min-h-72 sm:min-h-80 shadow transition-transform duration-200 ease-out hover:-translate-y-1 hover:shadow-lg fade-slide-in">
      {/* header */}
